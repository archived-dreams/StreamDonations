...
(function ($) {
  ...
  Selectpicker.prototype = {
    ...
    createDropdown: function () {
      ...
      '<button type="button" class="actions-btn bs-select-all btn btn-second">' +
      this.options.selectAllText +
      '</button>' +
      '<button type="button" class="actions-btn bs-deselect-all btn btn-second">' +
      ...
      '<button type="button" class="btn btn-sm btn-second">' +
